...
void main() {
  group('NebulaContainer', () {
    testWidgets('renders child widget', (tester) async {
      await tester.pumpWidget(
        _wrap(const NebulaContainer(child: Text('Hello'))),
      );
      await tester.pump();
    ...
    testWidgets('uses Container internally', (tester) async {
      await tester.pumpWidget(
        _wrap(const NebulaContainer(child: Text('Test'))),
      );
      await tester.pump();
    ...
    testWidgets('renders border when showBorder is true (default)', (
      ...
      await tester.pumpWidget(
        _wrap(const NebulaContainer(child: Text('Bordered'))),
      );
      await tester.pump();

      final container = tester.widget<Container>(
        find.descendant(
          of: find.byType(NebulaContainer),
    ...
    testWidgets('does not render border when showBorder is false', (
      ...
      await tester.pumpWidget(
        _wrap(
          const NebulaContainer(showBorder: false, child: Text('No border')),
        ),
      );
      await tester.pump();
    ...
    testWidgets('applies custom width and height', (tester) async {
      await tester.pumpWidget(
        _wrap(
          const NebulaContainer(width: 200, height: 100, child: Text('Sized')),
        ),
      );
      await tester.pump();
    ...
    testWidgets('applies gradient when provided', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(
          const NebulaContainer(gradient: gradient, child: Text('Gradient')),
        ),
      );
      await tester.pump();
    ...
    testWidgets('applies custom color when provided', (tester) async {
      await tester.pumpWidget(
        _wrap(const NebulaContainer(color: Colors.red, child: Text('Colored'))),
      );
      await tester.pump();
    ...
    testWidgets('applies custom padding', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(
          const NebulaContainer(padding: customPadding, child: Text('Padded')),
        ),
      );
      await tester.pump();
    ...
    testWidgets('applies custom margin', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(
          const NebulaContainer(margin: customMargin, child: Text('Margined')),
        ),
      );
      await tester.pump();
