...
void main() {
  group('NebulaOutlineIconButton.primary', () {
    testWidgets('renders the icon', (tester) async {
      await tester.pumpWidget(
        _wrap(
          NebulaOutlineIconButton.primary(icon: Icons.share, onPressed: () {}),
        ),
      );
      await tester.pump();
  ...
  group('NebulaOutlineIconButton.accent', () {
    testWidgets('renders the icon', (tester) async {
      await tester.pumpWidget(
        _wrap(
  ...
  group('NebulaOutlineIconButton.accentSecondary', () {
    testWidgets('renders the icon', (tester) async {
      await tester.pumpWidget(
        _wrap(
  ...
  group('NebulaOutlineIconButton.gradient', () {
    testWidgets('renders the icon', (tester) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('does not call onPressed when disabled', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(
          const NebulaOutlineIconButton.gradient(
            icon: Icons.auto_awesome_rounded,
            onPressed: null,
          ),
        ),
  ...
  group('NebulaOutlineIconButton.accentGradient', () {
    testWidgets('renders the icon', (tester) async {
      await tester.pumpWidget(
        _wrap(
