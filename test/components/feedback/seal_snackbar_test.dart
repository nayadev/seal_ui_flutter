...
/// Wraps [child] in a fully wired [SealTheme] + [MaterialApp] + [Scaffold].
///
...
void main() {
  group('SealSnackbar', () {
    ...
    testWidgets('info — renders message', (tester) async {
      ...
      SealSnackbar.info(message: 'Info message').show(ctx);
      await tester.pump();
    ...
    testWidgets('success — renders message', (tester) async {
      ...
      SealSnackbar.success(message: 'Saved!').show(ctx);
      await tester.pump();
    ...
    testWidgets('warning — renders message', (tester) async {
      ...
      SealSnackbar.warning(message: 'Be careful').show(ctx);
      await tester.pump();
    ...
    testWidgets('error — renders message', (tester) async {
      ...
      SealSnackbar.error(message: 'Something went wrong').show(ctx);
      await tester.pump();
    ...
    testWidgets('does not render title widget when title is null', (
      ...
      SealSnackbar.info(message: 'No title here').show(ctx);
      await tester.pump();
    ...
    testWidgets('does not render action button when actionLabel is null', (
      ...
      SealSnackbar.info(message: 'No action', onAction: () {}).show(ctx);
      await tester.pump();
    ...
    testWidgets('top — replaces any existing visible top snackbar', (
      ...
      SealSnackbar.info(message: 'First').show(ctx);
      await tester.pump();
      expect(find.text('First'), findsOneWidget);

      SealSnackbar.success(message: 'Second').show(ctx);
      await tester.pump();
    ...
    testWidgets('top alignment — renders via Overlay', (tester) async {
      ...
      SealSnackbar.info(
        ...
        alignment: SealSnackbarAlignment.top,
      ).show(ctx);
      await tester.pump();
