...
/// A styled container for the Nebula UI design system.
///
...
class NebulaContainer extends StatelessWidget {
  ...
  /// Custom padding — defaults to [NebulaDimension.md] on all sides.
  final EdgeInsetsGeometry? padding;

  /// Custom margin.
  final EdgeInsetsGeometry? margin;

  /// Custom border radius — defaults to [NebulaRadius.borderRadiusMd].
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveRadius = borderRadius ?? NebulaRadius.borderRadiusMd;
