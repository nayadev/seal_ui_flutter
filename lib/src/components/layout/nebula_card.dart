...
///
/// Uses Nebula design tokens for colors, spacing, border radius, and
...
class NebulaCard extends StatelessWidget {
  ...
  ///
  /// Defaults to [NebulaRadius.borderRadiusLg].
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveRadius = borderRadius ?? NebulaRadius.borderRadiusLg;
