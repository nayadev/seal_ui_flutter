    ...
    return Column(
      ...
      children: [
        ...
        SealSelect<String>(
          ...
          placeholder: const Text('Select timezone'),
          ...
          options: const [
            ...
            SealSelectOption(
              value: 'us_et',
              label: Text('America/New_York (ET)'),
            ),
            SealSelectOption(
              value: 'us_ct',
              label: Text('America/Chicago (CT)'),
            ),
            SealSelectOption(
              value: 'us_mt',
              label: Text('America/Denver (MT)'),
            ),
            SealSelectOption(
              value: 'us_pt',
        ...
        const SealTextarea(
          ...
          hint: Text('Enter a description…'),
        ),
        dimension.xs.verticalGap,
        const SealTextarea(hint: Text('Disabled'), enabled: false),
