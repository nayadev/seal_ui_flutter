...
@UseCase(name: 'Default', type: SealAccordion, path: '[Layout]/Accordion')
Widget buildSealAccordionDefault(BuildContext context) {
  return Padding(
...
@UseCase(name: 'Multiple', type: SealAccordion, path: '[Layout]/Accordion')
Widget buildSealAccordionMultiple(BuildContext context) {
  return Padding(
    padding: EdgeInsets.all(context.dimension.lg),
