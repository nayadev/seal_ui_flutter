...
/// Marker type for the spacing-scale widgetbook component.
abstract class SpacingScale {}

@UseCase(name: 'Visual Guide', type: SpacingScale, path: '[Layout]/Spacing')
Widget buildSpacingScaleVisualGuide(BuildContext context) {
